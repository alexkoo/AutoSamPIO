...
//**************************************************************************************************//EEPROM
byte autosam_mode_addr = 0;
byte press_corr_addr = 1;
float min_hot_temp_addr =2;
float heating_rate_addr = 6;
float max_tank_temp_addr = 10;
float max_steam_temp_addr = 14;
...
unsigned long Delay1 = 30;           // временная задержка включения клапана по температуре на 2/3 колонны (в секундах)
unsigned long Delay2 = 30;           // временная задержка включения клапана по температуре вверху колонны (в секундах)
...
float max_steam_temp = 80;  // макс температура  пара
